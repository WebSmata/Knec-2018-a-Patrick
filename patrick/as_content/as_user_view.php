          ...
          <br><hr><br>
			<div class="main_content">
				<div class="iconic_infol">
					...
					<a href="index.php?page=edituser&&as_userid=<?php echo $userid ?>"><h1>Edit User</h1></a>
					<hr class="detail_info_hr"/>
					<a href="index.php?page=deleteuser&&as_userid=<?php echo $userid ?>" onclick="return confirm('Are you sure you want to delete: <?php echo $user_name ?> from the system? \nBe roomeful, this page can not be reversed.')"><h1>Delete User</h1></a>
			    </div>
